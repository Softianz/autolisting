                                    ...
                                    <div class="flex-middle">
                                        ...
                                        <div class="listing-content">
                                            ...
                                            <div class="meta-listing">
                                                ...
                                                <?php if (get_current_user_id() == $myoffer->user_id) : 
                                                    $author = get_user_by('id', $myoffer->author_id);    
                                                ?>
                                                <span>Seller Email : <?= ($author) ? $author->user_email : '-'; ?></span>
                                                <?php listdo_display_listing_phone($job);  ?>
                                                <?php else : ?>
                                                    <span class="mb-0">Buyer Email : <?= $myoffer->user_email; ?></span><br>
                                                    <span>Buyer Phone : <?= $myoffer->user_phone; ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
