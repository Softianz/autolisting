									...
									<div class="group-field-item-content ">
				    					...
				    					<div class="row flex-middle-lg">
							    			...
							    			<div class="hours-last col-lg-5 col-xs-12">
										    	...
										    	<label><input type="radio" name="job_hours[day][<?php echo esc_attr($day); ?>][type]" value="open_all_day" <?php echo trim($type == 'open_all_day' ? 'checked="checked"' : ''); ?>> <?php esc_html_e('Available All Days', 'listdo'); ?></label>
										    	<label><input type="radio" name="job_hours[day][<?php echo esc_attr($day); ?>][type]" value="closed_all_day" <?php echo trim($type == 'closed_all_day' ? 'checked="checked"' : ''); ?>> <?php esc_html_e('Unavailable All Days', 'listdo'); ?></label>
										    </div>
									    </div>
					    			</div>
					    		</div>
