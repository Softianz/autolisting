	...
	<form method="post" action="?" id="scheduleMeeting">
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="form-group">
					<label>Email</label>
					<input type="email" class="form-control"  name="user_email" placeholder="<?php esc_attr_e('Your Email', 'listdo'); ?>" required="required">
				</div>
			</div>
			<div class="col-sm-12">
				<div class="form-group">
					<label>Phone</label>
					<input type="text" class="form-control"  name="user_phone" placeholder="<?php esc_attr_e('Your Phone Number', 'listdo'); ?>" required="required">
				</div>
			</div>
