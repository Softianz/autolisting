...
<div class="my-listing-item-wrapper job_listing ">
    ...
    line-height: 50px;
    margin-bottom: 5px;
    padding-top: 11px;;"><div>For</div><div>Sale!</div>  </div>
                        <div>
                            <img style="    width: 93%;
		...
		<div class="col-md-4 col-sm-3 col-xs-12 ali-right">
			<div class="right-inner">
                ...
                <!-- Trigger the modal with a button -->
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Sold Out</button>
                        ...
                        <!-- Modal content-->
                            <div class="modal-content" style="text-align:center;">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">AI Smart Sign</h4>
                                </div>
                                <div class="modal-body">
                                    <p>Congratulations! Your car has been sold. Thank you for using AI Smart Signs..</p>
                                </div>
