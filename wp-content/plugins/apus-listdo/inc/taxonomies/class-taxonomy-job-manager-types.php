...
class ApusListdo_Taxonomy_Types{
	...
	public static function change_taxonomy_type_label($args) {
		$singular = apply_filters( 'apus-listdo-job-listing-type-singular', esc_html__( 'Type', 'apus-listdo' ) );
		$plural   = apply_filters( 'apus-listdo-job-listing-type-plural', esc_html__( 'Types', 'apus-listdo' ) );
...
ApusListdo_Taxonomy_Types::init();