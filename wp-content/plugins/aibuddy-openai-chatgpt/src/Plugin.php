    ...
    private function create_container(): array
    {
        return [
            ...
            GoogleAiApi::class => function () {
                return new GoogleAiApi($this, $this->options->get('googleai.apikey', ''));
            },
            ClaudeAiApi::class => function () {
                return new ClaudeAiApi($this, $this->options->get('claude.apikey', ''));
            },
            OpenRouterApi::class => function () {
                return new OpenRouterApi($this, $this->options->get('openrouter.apikey', ''));
            },
